...
import 'package:hive_example_khatabook/rough.dart';
    ...
    if (widget.index != null) {
      setState(() {
        ...
        _box.getAt(widget.index!)['image'] != null
            ...
            : null;
        _box.getAt(widget.index!)['isCashIn']
            ? selectedIndex = 0
            : selectedIndex = 1;
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.index == null
            ? AppText.addClientText
            : AppText.editClientText),
      ),
      body: Form(
        key: formkey,
        child: Padding(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    child: widget.index == null
                        ? const Text(AppText.addClientText)
                        : const Text(AppText.editClientText)),
              ],
            ),
          ),
        ),
